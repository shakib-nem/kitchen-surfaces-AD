...
class BurgerData(Dataset):
    def __init__(self, imgSize: int, stride: int, image_folder: str, json_file = '/home/shn/PatchCore/white_with_edges_coords.json', transform=None) -> None:
        super().__init__()
        """
    ...
    def _generate_index2position(self):
        ...
        for filename in os.listdir(self.image_folder):
            if filename.endswith(supported_extensions):
                ...
                border_rect = borders[0]  # [bx, by, bw, bh]
    ...
    def __getitem__(self, index) -> torch.Tensor:
        ...
        #return patch_tensor, label , file, x, y #uncomment when using gradcam
